...
app.title = 'Covid19 - Bangladesh and Global Dashboard '
...
##############################################################################################################################
# Moving Bangladesh to the first row in the datatable (You can choose any country of interest to be display on the first row)
##############################################################################################################################

def df_move1st_sg(df_t):

    #Moving Bangladesh to the first row in the datatable
    df_t["new"] = range(1,len(df_t)+1)
    df_t.loc[df_t[df_t['Country/Region'] == 'Bangladesh'].index.values,'new'] = 0
...
map_data.loc[map_data[map_data['Country/Region'] == 'Bangladesh'].index.values,'new'] = 0
...
#############################################################################
mapbox_access_token = 'here paste your access token'
...
app.layout = html.Div(
    html.Div([
        ...
        html.Div(
            [
                html.H1(children='Covid-19 Dashboard for Bangladesh and Global perspective,\n developed by Hafez Ahmad',
                        style={
                            'textAlign': 'left',
                            'color': colors['text'],
                ...
                html.Div(children='To update .please Refresh browser ,you can sea it in Desktop.',
                         style={
                             'textAlign': 'left',
                             'color': colors['text'],
                             'backgroundColor': colors['background'],
...
#global map and table
        ...
        html.Div([
            ...
            html.Div(
                    [
                        html.Hr(),
                        html.P('You can email me  [hafezahmad100@gmail.com]  ',
                               style={'display': 'inline'}),
                        html.A('Github',
                               href='https://github.com/hafez-ahmad/covid19'),
                        html.P(' 2020.',
                            style={'display': 'inline'}),
                        html.P(' Click here to access ',
                            style={'display': 'inline'}),
                        html.A('developmental version',
                               href='https://github.com/hafez-ahmad/Covid19_dashboard_Bangladesh_and_Global'),
                        html.Hr(),
                    ], className="twelve columns",
